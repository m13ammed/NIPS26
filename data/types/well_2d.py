...
from data.pbdl.utilities import get_sel_const_sim
import numpy as np
...
def well_2d_datasets(
    ...
    **kwargs
    ...
    if variable_dt_stride_maximum <= 1:
        ...
        train = VariableDtDataset(
            **params_train, maximum_dt=variable_dt_stride_maximum, seed=None
        )
        val = VariableDtDataset(
            **params_val, maximum_dt=variable_dt_stride_maximum, seed=None
        )
