...
class Model(nn.Module):
    def __init__(self, args, bilinear=True, s1=96, s2=96):
        ...
        self.w3_down = ConvList[len(self.padding)](args.n_hidden * 4, args.n_hidden * 4, 1)
        self.w4_down = ConvList[len(self.padding)](args.n_hidden * 8, args.n_hidden * 8, 1)
        ...
        self.w3_up = ConvList[len(self.padding)](args.n_hidden * 4 // factor, args.n_hidden * 4 // factor, 1)
        self.w4_up = ConvList[len(self.padding)](args.n_hidden * 8 // factor, args.n_hidden * 8 // factor, 1)
        self.w5_up = ConvList[len(self.padding)](args.n_hidden * 16 // factor, args.n_hidden * 16 // factor, 1)
        # projectors
