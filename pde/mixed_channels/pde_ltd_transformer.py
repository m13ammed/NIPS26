        ...
        if self.use_sprint:
            ...
            if self.sprint_drop_mode == "entropy":
                ...
                for b in range(hidden_states.shape[0]):
                    emap = calc_entropy_map_gpu(
                        hidden_states[b], kernel_size=3, num_bins=32
                    )
                ...
                importance_map = torch.linalg.vector_norm(hidden_states, ord=2, dim=1)
            ...
            hidden_states, ids_keep = self._drop_tokens_sprint_blockwise(
                hidden_states, entropy_map=importance_map
            )
        ...
        for i in range(self.num_encoder_layers):
            ...
            self.__setattr__(
                ...
                PDEStage(
                    ...
                    window_size=window_size,
                    depth=depth[i],
                    # use_sprint=i % 2 == 0,  # every other layer
                    use_sprint=True,
                    **dit_stage_args,
                ),
            )
        ...
        for i in range(1, self.num_encoder_layers):
            ...
            self.__setattr__(
                ...
                PDEStage(
                    ...
                    # use_sprint=(
                    #     (i % 2 == 1)
                    #     if self.num_encoder_layers % 2 == 0
                    #     else (i % 2 == 0)
                    # ),
                    use_sprint=True,
                    **dit_stage_args,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        args = {
            ...
            "use_latent_residual": use_latent_residual,
            "use_gated_mlp": use_gated_mlp,
            "adjust_hidden": adjust_hidden,
            "use_output_proj": use_output_proj,
